...
public class TransactionExecutor {
    ...
    public void execute(ClientTransaction transaction) {
        ...
        executeCallbacks(transaction);// 循环遍历回调请求的所有状态并在适当的时间执行它们

        executeLifecycleState(transaction); // 如果事务请求，则转换到最终状态
    ...
    private void executeLifecycleState(ClientTransaction transaction) {
        ...
        lifecycleItem.execute(mTransactionHandler, token, mPendingActions); // 调用 ResumeActivityItem 的 execute() 来执行 onResume
