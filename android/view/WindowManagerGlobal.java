...
public final class WindowManagerGlobal {
    ...
    // 创建 viewRootImpl 并且和 decorView 进行绑定
    public void addView(View view, ViewGroup.LayoutParams params,
        ...
        synchronized (mLock) {
            ...
            mViews.add(view);// 缓存decorView
            mRoots.add(root);// 缓存 viewRootImpl
            mParams.add(wparams); // 缓存 layoutParams

            // do this last because it fires off messages to start doing things
            try {
                // view 和 viewRootImpl 正式绑定
                // 猜测: viewRootImpl 和 window 进行绑定
    ...
    public void updateViewLayout(View view, ViewGroup.LayoutParams params) {
        ...
        // PhoneWindow 实例化 decorView
        // 给 View 设置 WindowManager.LayoutParams
        view.setLayoutParams(wparams);
        ...
        synchronized (mLock) {
            ...
            // 存一份 windowParams 到 ViewRootImpl 中
